 ...
 */
function escapePromptURL(url: string) {
 ...
 * @param {FileList} files The files to upload the the server.
 */
    uploadImagesUsingCustomFunction(imageUploadFunction: Function, files: FileList) {
        if (files.length === 0) {
            return;
        }
        var names = [];
 ...
 */
    updateStatusBar(itemName: string, content: string) {
 ...
 */
     ...
     */
    uploadImage(file: File, onSuccess: Function, onError: Function) {
        var self = this;
     ...
     * @param file {File} The image to upload, as a HTML5 File object (https://developer.mozilla.org/en-US/docs/Web/API/File).
     */
    uploadImageUsingCustomFunction(imageUploadFunction: Function, file: File) {
        var self = this;
